...
function FavoritePage() {
    ...
    const renderCards = Favorites.map((favorite, index) => {
        ...
        return <tr key={index}>
            ...
            <td><button style={{backgroundColor: 'red'}} onClick={() => onClickDelete(favorite.movieId, favorite.userFrom)}> Remove </button></td>
        </tr>
    })

    return (
        <div style={{ width: '85%', margin: '3rem auto', color: 'white'}}>
            <Title level={2} style={{ color: 'white'}} > Favorite Movies By Me </Title>
            <hr />
